package com.example.mpfastbegin.annotation;
...
public class TestRuntimeAnnotation {
    ...
    public static void main(String[] args) {
        TestRuntimeAnnotation testRuntimeAnnotation = new TestRuntimeAnnotation();
        testRuntimeAnnotation._testRuntimeAnnotation();
    }
}